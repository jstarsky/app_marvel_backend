...
# Security
SECRET_KEY = config('SECRET_KEY', default='django-insecure-marvel-change-me-in-production')
...
# Database - Using SQLite for easy deployment
DATABASES = {
    'default': {
...
# Custom user model (using username only)
